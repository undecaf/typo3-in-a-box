...
-   `latest`: most recent image of the most recent TYPO3 version 
    (currently [`10.4.6`](https://packagist.org/packages/typo3/cms#v10.4.6))
-   `8.7-latest`, `9.5-latest`, `10.4-latest`:  
    ...
    [`9.5.20`](https://packagist.org/packages/typo3/cms#v9.5.20) and
    [`10.4.6`](https://packagist.org/packages/typo3/cms#v10.4.6))
